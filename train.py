...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='road',
                        choices=['pascal', 'coco', 'cityscapes', 'road'], help='dataset name (default: pascal)')
    parser.add_argument('--use-sbd', action='store_true', default=False,
                        help='whether to use SBD dataset (default: True)')
    parser.add_argument('--workers', type=int, default=1, metavar='N', help='dataloader threads')
    parser.add_argument('--base-size', type=int, default=720, help='base image size')
    parser.add_argument('--crop-size', type=int, default=720, help='crop image size')
